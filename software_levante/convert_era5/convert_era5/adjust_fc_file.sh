...
#SBATCH --output=slurm/adjust_FCOG/adjust_FCOG.o%j    # File name for standard output
#SBATCH --error=slurm/adjust_FCOG/adjust_FCOG.e%j     # File name for standard error output
